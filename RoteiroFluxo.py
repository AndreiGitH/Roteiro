...
def generate_script(client, model: str, original: str, analysis: str) -> str:
    prompt = (
        ...
        "sem [] ou divisões, ou marcações, aproximadamente 25 minutos, (3250 palavras), contendo trechos bíblicos, e uns 3 ditados populares. "
        ...
        if not tema.strip():
            ...
            with st.spinner("Gerando roteiro inicial..."):
                prompt_script = (
                    ...
                    # Truncated for brevity; continue prompt exactly as in roteirotema.py
                )
                # Complete adding the rest of the prompt from roteirotema.py here
            ...
            with st.spinner("Revisando e gerando novo roteiro..."):
                roteiro_final = generate_script(client, model_name, roteiro_inicial, analysis)
